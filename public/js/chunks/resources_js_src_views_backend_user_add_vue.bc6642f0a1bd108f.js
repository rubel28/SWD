  ...
  setup: function setup(__props, _ref) {
    ...
    var submit_form = function submit_form() {
      ...
      if (form1.value.name) {
        ...
        (_console = console).log.apply(_console, _toConsumableArray(form1)); //showMessage('Form submitted successfully.');
